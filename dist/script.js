...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_drop__WEBPACK_IMPORTED_MODULE_12__["default"])(); // console.dir(window.navigator.userAgent);
});
...
var calc = function calc(size, material, options, promocode, result) {
  ...
  var calcFunc = function calcFunc() {
    ...
    if (sizeBlock.value == '' || materialBlock.value == '') {
      ...
      resultBlock.textContent = "".concat(Math.round(sum * 0.7));
    } else {
      resultBlock.textContent = "".concat(sum);
    }
  };
...
var checkTextInput = function checkTextInput(selector) {
  ...
  fileInputs.forEach(function (input) {
    input.addEventListener('drop', function (e) {
      ...
      if (input.closest('.drop_file')) {
        ...
        Object(_services_requests__WEBPACK_IMPORTED_MODULE_6__["postData"])('assets/server.php', fileData).then(function (res) {
...
var forms = function forms() {
  ...
  forms.forEach(function (form) {
    form.addEventListener('submit', function (e) {
      ...
      textMessage.textContent = "".concat(message.loading);
...
var modals = function modals(state) {
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    function showModal() {
      windows.forEach(function (item) {
        item.style.display = 'none';
        document.querySelectorAll('.popup-content').forEach(function (elem) {
  ...
  function openByScroll(selector) {
    window.addEventListener('scroll', function () {
      ...
      var triggerSelector = document.querySelector(selector);
...
var showMoreStyles = function showMoreStyles(trigger, wrapper) {
  ...
  } // <div class="hidden-lg hidden-md hidden-sm hidden-xs styles-2"></div>
